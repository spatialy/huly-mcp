...
describe("Huly Errors", () => {
  ...
  describe("IssueNotFoundError", () => {
    // test-revizorro: approved
    it("creates with identifier and project", () => {
    ...
    // test-revizorro: approved
    it("generates message from fields", () => {
      const error = new IssueNotFoundError({ identifier: "HULY-123", project: "HULY" })
  ...
  describe("InvalidStatusError", () => {
    // test-revizorro: approved
    it("creates with status and project", () => {
  ...
  describe("getMcpErrorCode", () => {
    // test-revizorro: approved
    it("returns InvalidParams for domain errors", () => {
    ...
    // test-revizorro: approved
    it("returns InternalError for infrastructure errors", () => {
  ...
  describe("Effect integration", () => {
    ...
    // test-revizorro: approved
    it("can pattern match with Match", () => {
